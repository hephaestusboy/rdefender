...
if __name__ == "__main__":
    ...
    # Train both models
    # -----------------------------
    model1 = train_lgbm_model(X1, y, "Behavior")
    model2 = train_lgbm_model(X2, y, "Artifact")

    # -----------------------------
    # Save models
    # -----------------------------
    joblib.dump(model1, "lgbm_behavior_model.joblib")
    joblib.dump(model2, "lgbm_artifact_model.joblib")

    print("\nBoth LightGBM models saved successfully")
